...
#define KOISHI_COMPWISE_OP( op, ... )                                                                                                                                    \
	template <typename T, int = 0, typename = typename std::enable_if<trait::is_in<T, __VA_ARGS__>::value && trait::is_vec1<T>::value>::type>                            \
	KOISHI_HOST_DEVICE typename unnormalized_type<T>::type operator op( const T &a )                                                                                     \
	{                                                                                                                                                                    \
		return { op a.x };                                                                                                                                               \
	}                                                                                                                                                                    \
	template <typename T, int = 0, int = 0, typename = typename std::enable_if<trait::is_in<T, __VA_ARGS__>::value && trait::is_vec2<T>::value>::type>                   \
...
#define KOISHI_COMPWISE_OP( op, ... )                                                                                                                                    \
	template <typename T, int = 0, typename = typename std::enable_if<trait::is_in<T, __VA_ARGS__>::value && trait::is_vec1<T>::value>::type>                            \
	KOISHI_HOST_DEVICE typename unnormalized_type<T>::type operator op( const T &a, typename trait::com<T>::type b )                                                     \
	{                                                                                                                                                                    \
		return { a.x op b };                                                                                                                                             \
	}                                                                                                                                                                    \
	template <typename T, int = 0, int = 0, typename = typename std::enable_if<trait::is_in<T, __VA_ARGS__>::value && trait::is_vec2<T>::value>::type>                   \
	...
	template <typename T, int = 0, typename = typename std::enable_if<trait::is_in<T, __VA_ARGS__>::value && trait::is_vec1<T>::value>::type>                            \
	KOISHI_HOST_DEVICE typename unnormalized_type<T>::type operator op( typename trait::com<T>::type a, const T &b )                                                     \
	{                                                                                                                                                                    \
		return { a op b.x };                                                                                                                                             \
	}                                                                                                                                                                    \
	template <typename T, int = 0, int = 0, typename = typename std::enable_if<trait::is_in<T, __VA_ARGS__>::value && trait::is_vec2<T>::value>::type>                   \
...
#define KOISHI_COMPWISE_OP( op, ... )                                                                                                                                    \
	template <typename T, int = 0, typename = typename std::enable_if<trait::is_in<T, __VA_ARGS__>::value && trait::is_vec1<T>::value>::type>                            \
	KOISHI_HOST_DEVICE typename unnormalized_type<T>::type &operator op( T &a, typename trait::com<T>::type b )                                                          \
	{                                                                                                                                                                    \
		return a.x op b, a;                                                                                                                                              \
	}                                                                                                                                                                    \
	template <typename T, int = 0, int = 0, typename = typename std::enable_if<trait::is_in<T, __VA_ARGS__>::value && trait::is_vec2<T>::value>::type>                   \
...
#define KOISHI_COMPWISE_OP( op, ... )                                                                                                                                    \
	template <typename T, int = 0, typename = typename std::enable_if<trait::is_in<T, __VA_ARGS__>::value && trait::is_vec1<T>::value>::type>                            \
	KOISHI_HOST_DEVICE bool operator op( const T &a, typename trait::com<T>::type b )                                                                                    \
	{                                                                                                                                                                    \
		return a.x op b;                                                                                                                                                 \
	}                                                                                                                                                                    \
	template <typename T, int = 0, int = 0, typename = typename std::enable_if<trait::is_in<T, __VA_ARGS__>::value && trait::is_vec2<T>::value>::type>                   \
	...
	template <typename T, int = 0, typename = typename std::enable_if<trait::is_in<T, __VA_ARGS__>::value && trait::is_vec1<T>::value>::type>                            \
	KOISHI_HOST_DEVICE bool operator op( typename trait::com<T>::type a, const T &b )                                                                                    \
	{                                                                                                                                                                    \
		return b.x op a;                                                                                                                                                 \
	}                                                                                                                                                                    \
	template <typename T, int = 0, int = 0, typename = typename std::enable_if<trait::is_in<T, __VA_ARGS__>::value && trait::is_vec2<T>::value>::type>                   \
...
#define KOISHI_COMPWISE_OP( ... )                                                                                                                                        \
	...
	{                                                                                                                                                                    \
		return N * dot( static_cast<const T &>( N ), I ) * typename trait::com<T>::type( 2 ) - I;                                                                        \
	}                                                                                                                                                                    \
	template <typename T, int = 0, int = 0, typename = typename std::enable_if<trait::is_in<T, __VA_ARGS__>::value && trait::is_vec2<T>::value>::type>                   \
	KOISHI_HOST_DEVICE T reflect( const T &I, const typename normalized_type<T>::type &N )                                                                               \
	{                                                                                                                                                                    \
